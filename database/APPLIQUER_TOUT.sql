-- APPLIQUER_TOUT.sql : base neuve OU mise a niveau, en UNE execution.
-- Tous les blocs sont idempotents. Ordre : schema, fonctions, migrations.

-- >>>>>>>>>>>>>>>>>>>> supabase_schema_consolide.sql
-- ============================================================================
...
-- >>>>>>>>>>>>>>>>>>>> supabase_fonctions_consolidees.sql
-- ============================================================================
-- PME Gestion — Fonctions RPC Supabase CONSOLIDÉES — 2026-09-22
-- ============================================================================
-- ÉTAT FINAL des fonctions : ce fichier unique remplace, pour toute
-- INSTALLATION NEUVE, les blocs fonctions de supabase_functions.sql
-- (v1.0, v1.7 données de test, v1.8 storage, v1.9 bucket documents,
--  v1.10 durcissement anon, v1.11 sauvegardes, v1.12 audit trail).
-- Les blocs RLS redondants des migrations ne sont PAS repris ici : la
-- sécurité finale vit dans supabase_schema_consolide.sql (source unique).
--
-- Déploiement : APRÈS supabase_schema_consolide.sql, coller ce fichier → Run.
-- Tout est `create or replace` : ré-exécutable sans risque.
-- ============================================================================
...
-- ============================================================================
-- FIN DES FONCTIONS CONSOLIDÉES — base opérationnelle complète.
...
-- >>>>>>>>>>>>>>>>>>>> migration_modification_suppression_ventes.sql
-- ============================================================
...
-- >>>>>>>>>>>>>>>>>>>> migration_modification_suppression_collab.sql
-- ============================================================
...
-- >>>>>>>>>>>>>>>>>>>> migration_mouvements_stock.sql
-- ============================================================================
...
-- >>>>>>>>>>>>>>>>>>>> migration_fixes_critiques_rls.sql
-- ============================================================================
...
-- >>>>>>>>>>>>>>>>>>>> migration_signatures_documents.sql
-- ============================================================================
